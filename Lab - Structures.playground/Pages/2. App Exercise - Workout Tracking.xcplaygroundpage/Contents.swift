...
struct RunningWorkout {
    ...
    func printSummary() {
        print("Here a summary of your run today. Distance ran: \(firstRun.distance) meters. Active run time: \(firstRun.time) minutes. Elevation:  \(firstRun.elevation) meters.")
    }
}
