...
let favoriteBook = Book(title: "Becoming", author: "Michelle Obama", pages: 456, price: 40.50)
favoriteBook.printStatement()
/*:
 ...
 */
let myHeight = Height(heightInCentimeters: 166.6)
print(myHeight)
